...
public class HomeFragment1 extends Fragment implements View.OnClickListener {
    ...
    TextView tvAchievedSale, tvTargetSale, tvAchievedNo, tvTargetNo, tv1;
    CardView cvStock, cvOrder, cvTeam, cvInvoices, cvReports, cvMyProfile;
...
//    private ViewPager viewPager;
    ...
    @SuppressLint("ValidFragment")
    public HomeFragment1(MainActivity context) {
...
//            tv1.setText("Agent");
        ...
        if (!userType.equalsIgnoreCase("Admin") && !userType.equalsIgnoreCase("Distributor")){
